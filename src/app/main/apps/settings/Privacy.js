...
function Terms() {
    ...
    useEffect(() => {
        ...
        axios.post(apiBaseUrl + "/graphql",
            {
                query: "query request { GetSettings {  privacyEn,privacyAr } }"
            }
        ).then((res) => {
            if (res.data.data.GetSettings.privacyEn === null) {
                res.data.data.GetSettings.privacyEn = "";
            }

            if (res.data.data.GetSettings.privacyAr === null) {
                res.data.data.GetSettings.privacyAr = "";
            }
            setPrivacyEn(res.data.data.GetSettings.privacyEn);
            setPrivacyAr(res.data.data.GetSettings.privacyAr);
        })
