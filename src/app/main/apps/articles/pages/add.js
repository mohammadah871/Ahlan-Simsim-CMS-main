...
function Edit(props) {
    ...
    const submitData = (dataVal) => {
        let query = `
        mutation {
            CreateSubject(subjectInput: { nameAr: "${dataVal.nameAr}",nameEn: "${dataVal.nameEn}",color:"${dataVal.color}" }),
            {
                name
            }
          }
        ...
        let final_query = {
            "query": "mutation CreateArticle($articleInputData: ArticleInputData) {\r\n  CreateArticle(articleInputData: $articleInputData) {\r\n    title\r\n    description\r\n    id\r\n  }\r\n}",
            "variables": {
