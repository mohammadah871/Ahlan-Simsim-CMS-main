    ...
    <>
      ...
      >
        ...
        {user.photoURL ? (
          ...
          <Avatar className="md:mx-4">          {user?.displayName?.substring(0, 1)}
          </Avatar>
        )}
      </Button>
      ...
      >
        {!user.role || user.role.length === 0 ? (
          <>
            <MenuItem component={Link} to={process.env.PUBLIC_URL + "/sign-in"} role="button">
          ...
          <>
            ...
            <MenuItem
              component={NavLink}
              to={process.env.PUBLIC_URL + "/sign-out"}
              onClick={() => {
                userMenuClose();
              }}
            >
