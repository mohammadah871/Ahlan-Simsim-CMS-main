...
import iconSlide5 from "../icons/iconSlide5.svg";
...
export default function ProgramInnerType4Slide3({ data }) {
  ...
  const renderItem = (data, index) => {
    return (
      ...
      >
        <div id="content1" dangerouslySetInnerHTML={{ __html: data }} />
      </Typography>
    );
  };
  ...
  const renderReadMore = (index) => {
    ...
    if (rows[index].description.length < 150) return null;
              ...
              >
                ...
                >
                  <AccordionNumberComponent
                    ...
                    color={
                      index % 2 === 0
                        ? data?.data?.data2?.color4
                        : data?.data?.data2?.color3
                    }
                  />
                  ...
                  >
...

                    {
                      ...
                      arrExpanded[index] === true && renderReadMore(index)
                    }
                  </AccordionSummary>
                </div>
              </Accordion>
